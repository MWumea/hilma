...
class Room {
    ...
    setupGalleryLighting() {
        ...
        // JUSTERAD: Flyttad upp 5cm för att sitta närmare takramen.
        const fixtureYPosition = this.roomSize.height - 0.05; 
        // JUSTERAD: Flyttad närmare väggen (från 20cm till 10cm).
        ...
        this.paintings.forEach((paintingWrapper) => { 
            ...
            // ÅTERSTÄLLD LOGIK: Denna korsvisa belysning är avsiktlig.
            // Lampan för en tavla på framväggen sitter på bakväggen, etc.
